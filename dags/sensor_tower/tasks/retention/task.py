...
from sensor_tower.operators import RetentionEndpointOperator
...
def group_tasks_get_quaterly_retention_data_in_specific_app_ids(
        ds: str,
        group_task_id,
        gcs_bucket,
        gcs_prefix,
    ...
    with TaskGroup(
        ...
        for country in list(COUNTRY_CODES.keys()):
            task = RetentionEndpointOperator(
                    ds=ds,
                    task_id=f'get_quarterly_retention_data_country_{country}',
