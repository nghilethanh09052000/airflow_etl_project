...
from sensor_tower.operators import DownloadsBySourcesEndpointOperator
...
def task_get_download_by_source_all_countries_data_on_specific_app_ids(
    ds: str,
    task_id: str,
    gcs_bucket: str,
    gcs_prefix: str,
    ...
    return DownloadsBySourcesEndpointOperator(
            ds=ds,
            task_id=task_id,
