...
from sensor_tower.operators import SaleReportEstimateEndpointOperator
...
def task_get_daily_sales_report_estimates_data_on_specific_app_ids(
        ds: str,
        task_id: str,
        gcs_bucket: str,
        gcs_prefix: str,
    ...
    return SaleReportEstimateEndpointOperator(
        ds=ds,
        task_id=task_id,
